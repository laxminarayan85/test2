package com.efi.printsmith.business.commandDelegates.SystemPreferences
{
	...
	public class SystemPreferencesPendingListPanelDelegate extends InterfaceCommandDelegate 
	{
		public function SystemPreferencesPendingListPanelDelegate(responder:IResponder) {
			super(responder);
		}
		
		public function handleUIEvent(event:SystemPreferencesPendingListPanelEvent):void {
			if (checkSecurity(SystemPreferencesPendingListPanelEvent.COMMANDID)) {
				event.enabled = true;
