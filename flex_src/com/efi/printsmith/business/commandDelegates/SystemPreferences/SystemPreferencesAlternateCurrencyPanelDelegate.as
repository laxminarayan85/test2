package com.efi.printsmith.business.commandDelegates.SystemPreferences
{
	...
	public class SystemPreferencesAlternateCurrencyPanelDelegate extends InterfaceCommandDelegate 
	{
		public function SystemPreferencesAlternateCurrencyPanelDelegate(responder:IResponder) {
			super(responder);
		}
		
		public function handleUIEvent(event:SystemPreferencesAlternateCurrencyPanelEvent):void {
			if (checkSecurity(SystemPreferencesAlternateCurrencyPanelEvent.COMMANDID)) {
				event.enabled = true;
