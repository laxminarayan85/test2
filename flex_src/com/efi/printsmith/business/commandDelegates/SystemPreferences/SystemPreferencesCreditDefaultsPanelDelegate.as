package com.efi.printsmith.business.commandDelegates.SystemPreferences
{
	...
	public class SystemPreferencesCreditDefaultsPanelDelegate extends InterfaceCommandDelegate 
	{
		public function SystemPreferencesCreditDefaultsPanelDelegate(responder:IResponder) {
			super(responder);
		}
		
		public function handleUIEvent(event:SystemPreferencesCreditDefaultsPanelEvent):void {
			if (checkSecurity(SystemPreferencesCreditDefaultsPanelEvent.COMMANDID)) {
				event.enabled = true;
