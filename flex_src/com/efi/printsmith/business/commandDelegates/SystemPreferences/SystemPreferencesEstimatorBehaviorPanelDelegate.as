package com.efi.printsmith.business.commandDelegates.SystemPreferences
{
	...
	public class SystemPreferencesEstimatorBehaviorPanelDelegate extends InterfaceCommandDelegate 
	{
		public function SystemPreferencesEstimatorBehaviorPanelDelegate(responder:IResponder) {
			super(responder);
		}
		
		public function handleUIEvent(event:SystemPreferencesEstimatorBehaviorPanelEvent):void {
			if (checkSecurity(SystemPreferencesEstimatorBehaviorPanelEvent.COMMANDID)) {
				event.enabled = true;
