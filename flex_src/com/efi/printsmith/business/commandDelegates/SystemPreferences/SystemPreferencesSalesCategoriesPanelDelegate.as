package com.efi.printsmith.business.commandDelegates.SystemPreferences
{
	...
	public class SystemPreferencesSalesCategoriesPanelDelegate extends InterfaceCommandDelegate 
	{
		public function SystemPreferencesSalesCategoriesPanelDelegate(responder:IResponder) {
			super(responder);
		}
		
		public function handleUIEvent(event:SystemPreferencesSalesCategoriesPanelEvent):void {
			if (checkSecurity(SystemPreferencesSalesCategoriesPanelEvent.COMMANDID)) {
				event.enabled = true;
