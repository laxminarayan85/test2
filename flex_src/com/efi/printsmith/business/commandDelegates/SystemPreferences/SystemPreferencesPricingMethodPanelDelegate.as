package com.efi.printsmith.business.commandDelegates.SystemPreferences
{
	...
	public class SystemPreferencesPricingMethodPanelDelegate extends InterfaceCommandDelegate 
	{
		public function SystemPreferencesPricingMethodPanelDelegate(responder:IResponder) {
			super(responder);
		}
		
		public function handleUIEvent(event:SystemPreferencesPricingMethodPanelEvent):void {
			if (checkSecurity(SystemPreferencesPricingMethodPanelEvent.COMMANDID)) {
				event.enabled = true;
