package com.efi.printsmith.business.commandDelegates.SystemPreferences
{
	...
	public class SystemPreferencesMarkupsPanelDelegate extends InterfaceCommandDelegate 
	{
		public function SystemPreferencesMarkupsPanelDelegate(responder:IResponder) {
			super(responder);
		}
		
		public function handleUIEvent(event:SystemPreferencesMarkupsPanelEvent):void {
			if (checkSecurity(SystemPreferencesMarkupsPanelEvent.COMMANDID)) {
				event.enabled = true;
