package com.efi.printsmith.business.commandDelegates.SystemPreferences
{
	...
	public class SystemPreferencesCreditCardInfoPanelDelegate extends InterfaceCommandDelegate 
	{
		public function SystemPreferencesCreditCardInfoPanelDelegate(responder:IResponder) {
			super(responder);
		}
		
		public function handleUIEvent(event:SystemPreferencesCreditCardInfoPanelEvent):void {
			if (checkSecurity(SystemPreferencesCreditCardInfoPanelEvent.COMMANDID)) {
				event.enabled = true;
