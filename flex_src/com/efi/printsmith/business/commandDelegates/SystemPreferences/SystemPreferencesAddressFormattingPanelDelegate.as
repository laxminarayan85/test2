package com.efi.printsmith.business.commandDelegates.SystemPreferences
{
	...
	public class SystemPreferencesAddressFormattingPanelDelegate extends InterfaceCommandDelegate 
	{
		public function SystemPreferencesAddressFormattingPanelDelegate(responder:IResponder) {
			super(responder);
		}
		
		public function handleUIEvent(event:SystemPreferencesAddressFormattingPanelEvent):void {
			if (checkSecurity(SystemPreferencesAddressFormattingPanelEvent.COMMANDID)) {
				event.enabled = true;
