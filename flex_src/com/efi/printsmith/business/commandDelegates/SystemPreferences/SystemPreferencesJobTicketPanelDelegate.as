package com.efi.printsmith.business.commandDelegates.SystemPreferences
{
	...
	public class SystemPreferencesJobTicketPanelDelegate extends InterfaceCommandDelegate 
	{
		public function SystemPreferencesJobTicketPanelDelegate(responder:IResponder) {
			super(responder);
		}
		
		public function handleUIEvent(event:SystemPreferencesJobTicketPanelEvent):void {
			if (checkSecurity(SystemPreferencesJobTicketPanelEvent.COMMANDID)) {
				event.enabled = true;
