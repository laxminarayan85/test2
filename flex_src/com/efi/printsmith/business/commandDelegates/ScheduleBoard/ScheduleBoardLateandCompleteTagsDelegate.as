package com.efi.printsmith.business.commandDelegates.ScheduleBoard
{
	...
	public class ScheduleBoardLateandCompleteTagsDelegate extends InterfaceCommandDelegate 
	{
		public function ScheduleBoardLateandCompleteTagsDelegate(responder:IResponder) {
			super(responder);
		}
		
		public function handleUIEvent(event:ScheduleBoardLateandCompleteTagsEvent):void {
			if (checkSecurity(ScheduleBoardLateandCompleteTagsEvent.COMMANDID)) {
				event.enabled = true;
