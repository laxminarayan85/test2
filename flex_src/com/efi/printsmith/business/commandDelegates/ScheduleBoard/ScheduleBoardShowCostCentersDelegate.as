package com.efi.printsmith.business.commandDelegates.ScheduleBoard
{
	...
	public class ScheduleBoardShowCostCentersDelegate extends InterfaceCommandDelegate 
	{
		public function ScheduleBoardShowCostCentersDelegate(responder:IResponder) {
			super(responder);
		}
		
		public function handleUIEvent(event:ScheduleBoardShowCostCentersEvent):void {
			if (checkSecurity(ScheduleBoardShowCostCentersEvent.COMMANDID)) {
				event.enabled = true;
