package com.efi.printsmith.business.commandDelegates.PendingList
{
	...
	public class PendingListPickupDelegate extends InterfaceCommandDelegate 
	{
		public function PendingListPickupDelegate(responder:IResponder) {
			super(responder);
		}
		
		public function handleUIEvent(event:PendingListPickupEvent):void {
			if (checkSecurity(PendingListPickupEvent.COMMANDID)) {
