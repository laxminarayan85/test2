package com.efi.printsmith.business.commandDelegates.EditForms
{
	...
	import com.efi.printsmith.view.WebAdministration;
	...
	public class EditWebAdminDelegate extends InterfaceCommandDelegate 
	{
		...
		public function handleUIEvent(event:EditWebAdminEvent):void {
			if (checkSecurity(EditWebAdminEvent.COMMANDID)) {
				var child:WebAdministration = new WebAdministration();
