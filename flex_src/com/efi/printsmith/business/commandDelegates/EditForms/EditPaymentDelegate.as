package com.efi.printsmith.business.commandDelegates.EditForms
{
	...
	import com.efi.printsmith.view.PostPayment;
	...
	public class EditPaymentDelegate extends InterfaceCommandDelegate 
	{
		public function EditPaymentDelegate(responder:IResponder) {
			super(responder);
		}
		
		public function handleUIEvent(event:EditPaymentEvent):void {
			if (checkSecurity(EditPaymentEvent.COMMANDID)) {
				var child:PostPayment = new PostPayment();
