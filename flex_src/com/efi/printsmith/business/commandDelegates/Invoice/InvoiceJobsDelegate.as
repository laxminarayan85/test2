package com.efi.printsmith.business.commandDelegates.Invoice
{
	...
	public class InvoiceJobsDelegate extends InterfaceCommandDelegate 
	{
		public function InvoiceJobsDelegate(responder:IResponder) {
			super(responder);
		}
		
		public function handleUIEvent(event:InvoiceJobsEvent):void {
			if (checkSecurity(InvoiceJobsEvent.COMMANDID)) {
				event.enabled = true;
