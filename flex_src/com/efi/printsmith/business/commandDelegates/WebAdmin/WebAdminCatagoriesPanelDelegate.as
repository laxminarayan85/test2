package com.efi.printsmith.business.commandDelegates.WebAdmin
{
	...
	public class WebAdminCatagoriesPanelDelegate extends InterfaceCommandDelegate 
	{
		public function WebAdminCatagoriesPanelDelegate(responder:IResponder) {
			super(responder);
		}
		
		public function handleUIEvent(event:WebAdminCatagoriesPanelEvent):void {
			if (checkSecurity(WebAdminCatagoriesPanelEvent.COMMANDID)) {
				event.enabled = true;
