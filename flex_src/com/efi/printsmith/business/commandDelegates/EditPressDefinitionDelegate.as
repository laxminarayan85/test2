package com.efi.printsmith.business.commandDelegates
{
	...
	public class EditPressDefinitionDelegate extends InterfaceCommandDelegate 
	{
		public function EditPressDefinitionDelegate(responder:IResponder) {
			super(responder);
		}
		
		public function handleUIEvent(event:EditPressDefinitionEvent):void {
			if (checkSecurity(EditPressDefinitionEvent.COMMANDID)) {
