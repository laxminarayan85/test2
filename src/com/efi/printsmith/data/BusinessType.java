 ...
 */	
@NamedQueries({
  @NamedQuery(name = "BusinessType.findall", query = "from BusinessType"),
  @NamedQuery(name = "BusinessType.byId", query = "select a from BusinessType a where a.id= :id")
})
...
@SQLDelete(sql="update modelbase set isdeleted='TRUE' from businesstype where modelbase.id=?")
