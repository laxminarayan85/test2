...
@Table(name = "charge")
// @SQLDelete(sql=
// "update modelbase set isdeleted='TRUE' from charge where modelbase.id=?")
...
public class Charge extends ModelBase {
	...
	public void setProperty(String propertyName, Object newValue)
		...
		if (CHARGEDEFINITION.equals(propertyName))
			setChargeDefinition((ChargeDefinition) newValue);
		else if (DESCRIPTION.equals(propertyName))
			setDescription((String) newValue);
		else if (NOTES.equals(propertyName))
			setNotes((String) newValue);
		else if (PRODUCTIONLOCATION.equals(propertyName))
			setProductionLocation((ProductionLocations) newValue);
		else if (SHOWNOTES.equals(propertyName))
			setShowNotes((Boolean) newValue);
		else if (FINISHED.equals(propertyName))
			setFinished((Boolean) newValue);
		else if (TAXABLE.equals(propertyName))
			setTaxable((Boolean) newValue);
		else if (BROKERED.equals(propertyName))
			setBrokered((Boolean) newValue);
		else if (DISPLAYQTY.equals(propertyName))
			setDisplayQty((Boolean) newValue);
		else if (HIDDEN.equals(propertyName))
			setHidden((Boolean) newValue);
		else if (HIDEPRICE.equals(propertyName))
			setHidePrice((Boolean) newValue);
		else if (PRICE.equals(propertyName))
			setPrice((BigDecimal) newValue);
		else if (OVERRIDEPRICE.equals(propertyName))
			setOverridePrice((Boolean) newValue);
		else if (QUANTITY.equals(propertyName))
			setQuantity((Double) newValue);
		else if (OVERRIDEQUANTITY.equals(propertyName))
			setOverrideQuantity((Boolean) newValue);
		else if (MATERIALQTY.equals(propertyName))
			setMaterialQty((Double) newValue);
		else if (OVERRIDEMATERIALQUANTITY.equals(propertyName))
			setOverrideMaterialQuantity((Boolean) newValue);
		else if (RATE.equals(propertyName))
			setRate((BigDecimal) newValue);
		else if (OVERRIDERATE.equals(propertyName))
			setOverrideRate((Boolean) newValue);
		else if (UP.equals(propertyName))
			setUp((Integer) newValue);
		else if (OVERRIDEUP.equals(propertyName))
			setOverrideUp((Boolean) newValue);
		else if (PARENTJOB.equals(propertyName))
			setParentJob((JobBase) newValue);
		else if (PARENTINVOICE.equals(propertyName))
			setParentInvoice((InvoiceBase) newValue);
		else if (MINIMUMCHARGE.equals(propertyName))
			setMinimumCharge((BigDecimal) newValue);
		else if (SETS.equals(propertyName))
			setSets((Double) newValue);
		else if (MATERIALSETS.equals(propertyName))
			setMaterialSets((Double) newValue);
		else if (QTYPERSET.equals(propertyName))
			setQtyPerSet((Double) newValue);
		else if (STARTHOURS.equals(propertyName))
			setStartHours((Integer) newValue);
		else if (ENDHOURS.equals(propertyName))
			setEndHours((Integer) newValue);
		else if (CHARGECOSTINGRECORD.equals(propertyName))
			setChargeCostingRecord((ChargeCostingRecord) newValue);
		else if (NEXTRECORD.equals(propertyName))
			setNextRecord((String) newValue);
		else if (STARTMINUTES.equals(propertyName))
			setStartMinutes((Integer) newValue);
		else if (ENDMINUTES.equals(propertyName))
			setEndMinutes((Integer) newValue);
		else if (OVERRIDEWEIGHT.equals(propertyName))
			setOverrideWeight((Boolean) newValue);
		else if (LINEARX1.equals(propertyName))
			setLinearX1((Boolean) newValue);
		else if (LINEARX2.equals(propertyName))
			setLinearX2((Boolean) newValue);
		else if (LINEARY1.equals(propertyName))
			setLinearY1((Boolean) newValue);
		else if (LINEARY2.equals(propertyName))
			setLinearY2((Boolean) newValue);
		else if (TAXTABLE.equals(propertyName))
			setTaxTable((TaxTable) newValue);
		else if (CHARGENUMBER.equals(propertyName))
			setChargeNumber((Long) newValue);
		else
	...
	public boolean deepEquals(Object obj) {
		...
		if (!SmartEquals(getMaterialQty(), objT.getMaterialQty()))
			return false;
		if (!SmartEquals(getOverrideMaterialQuantity(), objT
				.getOverrideMaterialQuantity()))
			return false;
		...
		if (!SmartEquals(getEndHours(), objT.getEndHours()))
			return false;
		if (!SmartEquals(getChargeCostingRecord(), objT
