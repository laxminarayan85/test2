...
public class Charge extends ModelBase {
	...
	public Class<?> getPropertyOwner(String propertyName) throws UnknownPropertyException {	
		...
		if (TITLE.equals(propertyName)) return Charge.class;
		if (NOTE.equals(propertyName)) return Charge.class;
		if (CHARGEGROUP.equals(propertyName)) return Charge.class;
		if (SALESCATEGORY.equals(propertyName)) return Charge.class;
		if (TAXTABLE.equals(propertyName)) return Charge.class;
		if (RATEQTY.equals(propertyName)) return Charge.class;
		if (MATERIALQTY.equals(propertyName)) return Charge.class;
		if (GROUPQTY.equals(propertyName)) return Charge.class;
		if (PRICE.equals(propertyName)) return Charge.class;
		if (TIMESTART.equals(propertyName)) return Charge.class;
		if (TIMEEND.equals(propertyName)) return Charge.class;
		if (CUSTOMERCHARGE.equals(propertyName)) return Charge.class;
		if (PRESSCHARGE.equals(propertyName)) return Charge.class;
		if (HIDDEN.equals(propertyName)) return Charge.class;
		if (DELETEDPRESET.equals(propertyName)) return Charge.class;
		if (IGNORECUTS.equals(propertyName)) return Charge.class;
		if (USESIGNATURES.equals(propertyName)) return Charge.class;
		if (STOCKCHARGE.equals(propertyName)) return Charge.class;
		if (OVERRIDENUMBEROFCUTS.equals(propertyName)) return Charge.class;
		...
		if (OVERRIDERATEQUANTITY.equals(propertyName)) return Charge.class;
		if (OVERRIDEMATERIALQTY.equals(propertyName)) return Charge.class;
		if (VERSION.equals(propertyName)) return Charge.class;
		if (SHIPMODE.equals(propertyName)) return Charge.class;
		if (ADJUSTUPSCOUNT.equals(propertyName)) return Charge.class;
		if (HASLINKPRICE.equals(propertyName)) return Charge.class;
		if (NEEDLINKPRICE.equals(propertyName)) return Charge.class;
		if (HASSHIPPED.equals(propertyName)) return Charge.class;
		if (SHOULDSHIP.equals(propertyName)) return Charge.class;
		if (JOBTASKLIST.equals(propertyName)) return Charge.class;
		if (HIDEPRICE.equals(propertyName)) return Charge.class;
		if (IGNOREPRICEADJUSTMENT.equals(propertyName)) return Charge.class;
		if (COSTINGPRESSCHARGE.equals(propertyName)) return Charge.class;
		...
		if (BINDERYCHARGE.equals(propertyName)) return Charge.class;
		if (NAME.equals(propertyName)) return Charge.class;
