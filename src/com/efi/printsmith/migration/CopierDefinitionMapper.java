	...
	public ModelBase importTokens(String[] fieldTokens, String[] importTokens) throws Exception {
		...
		for (int i=0; i < fieldTokens.length; i++) {
			...
			if ("recno".equals(currentFieldToken)) {
				...
				copierDefinition.setCopyMinutes(Utilities.tokenToDouble(currentImportToken));
			} else if ("efficiency".equals(currentFieldToken)) {
				/* TODO */
			} else if ("maintenance".equals(currentFieldToken)) {
				copierDefinition.setMonthlyMaintenance(Utilities.tokenToDouble(currentImportToken));
				...
				copierDefinition.setTonerCopy(Utilities.tokenToDouble(currentImportToken));
			} else if ("developer".equals(currentFieldToken)) {
				copierDefinition.setDeveloperCopy(Utilities.tokenToDouble(currentImportToken));
				...
				/* TODO */
			} else if ("chart qty[2]".equals(currentFieldToken)) {
				/* TODO */
			} else if ("chart qty[3]".equals(currentFieldToken)) {
				/* TODO */
			} else if ("chart qty[4]".equals(currentFieldToken)) {
				/* TODO */
			} else if ("chart qty[5]".equals(currentFieldToken)) {
				/* TODO */
			} else if ("chart qty[6]".equals(currentFieldToken)) {
				/* TODO */
			} else if ("chart qty[7]".equals(currentFieldToken)) {
				/* TODO */
			} else if ("chart qty[8]".equals(currentFieldToken)) {
				/* TODO */
			} else if ("chart qty[9]".equals(currentFieldToken)) {
				/* TODO */
			} else if ("chart qty[10]".equals(currentFieldToken)) {
				/* TODO */
			} else if ("chart qty[11]".equals(currentFieldToken)) {
				/* TODO */
			} else if ("chart qty[12]".equals(currentFieldToken)) {
				/* TODO */
			} else if ("chart qty[13]".equals(currentFieldToken)) {
				/* TODO */
			} else if ("chart qty[14]".equals(currentFieldToken)) {
				/* TODO */
			} else if ("chart qty[15]".equals(currentFieldToken)) {
				/* TODO */
