 ...
 */
public class ItemDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.efi.printsmith.integration.xpedx.xsd .ItemDocument
{
     ...
     */
    public com.efi.printsmith.integration.xpedx.xsd .ItemDocument.Item getItem()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.efi.printsmith.integration.xpedx.xsd .ItemDocument.Item target = null;
            target = (com.efi.printsmith.integration.xpedx.xsd .ItemDocument.Item)get_store().find_element_user(ITEM$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setItem(com.efi.printsmith.integration.xpedx.xsd .ItemDocument.Item item)
    {
     ...
     * This is a complex type.
     */
    public static class ItemImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.efi.printsmith.integration.xpedx.xsd .ItemDocument.Item
    {
        private static final long serialVersionUID = 1L;
