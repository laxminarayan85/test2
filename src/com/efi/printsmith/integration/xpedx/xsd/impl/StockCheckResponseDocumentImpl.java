 ...
 */
public class StockCheckResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.efi.printsmith.integration.xpedx.xsd .StockCheckResponseDocument
{
    ...
    public com.efi.printsmith.integration.xpedx.xsd .StockCheckResponseDocument.StockCheckResponse getStockCheckResponse()
    {
        synchronized (monitor())
        {
            ...
            target = (com.efi.printsmith.integration.xpedx.xsd .StockCheckResponseDocument.StockCheckResponse)get_store().find_element_user(STOCKCHECKRESPONSE$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public com.efi.printsmith.integration.xpedx.xsd .StockCheckResponseDocument.StockCheckResponse addNewStockCheckResponse()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.efi.printsmith.integration.xpedx.xsd .StockCheckResponseDocument.StockCheckResponse target = null;
            target = (com.efi.printsmith.integration.xpedx.xsd .StockCheckResponseDocument.StockCheckResponse)get_store().add_element_user(STOCKCHECKRESPONSE$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class StockCheckResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.efi.printsmith.integration.xpedx.xsd .StockCheckResponseDocument.StockCheckResponse
    {
        private static final long serialVersionUID = 1L;
        ...
        public com.efi.printsmith.integration.xpedx.xsd .ItemsDocument.Items getItems()
        {
            synchronized (monitor())
            {
                ...
                target = (com.efi.printsmith.integration.xpedx.xsd .ItemsDocument.Items)get_store().find_element_user(ITEMS$6, 0);
                if (target == null)
                {
                    return null;
                }
        ...
        public com.efi.printsmith.integration.xpedx.xsd .ItemsDocument.Items addNewItems()
        {
            synchronized (monitor())
            {
                check_orphaned();
                com.efi.printsmith.integration.xpedx.xsd .ItemsDocument.Items target = null;
                target = (com.efi.printsmith.integration.xpedx.xsd .ItemsDocument.Items)get_store().add_element_user(ITEMS$6);
                return target;
            }
        }
    }
