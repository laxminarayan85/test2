 ...
 */
public class ItemsDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.efi.printsmith.integration.xpedx.xsd.request.ItemsDocument
{
     ...
     * This is a complex type.
     */
    public static class ItemsImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.efi.printsmith.integration.xpedx.xsd.request.ItemsDocument.Items
    {
        private static final long serialVersionUID = 1L;
         ...
         */
        public com.efi.printsmith.integration.xpedx.xsd.request.ItemDocument.Item[] getItemArray()
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                com.efi.printsmith.integration.xpedx.xsd.request.ItemDocument.Item[] result = new com.efi.printsmith.integration.xpedx.xsd.request.ItemDocument.Item[targetList.size()];
         ...
         */
        public com.efi.printsmith.integration.xpedx.xsd.request.ItemDocument.Item getItemArray(int i)
        {
            synchronized (monitor())
            {
                check_orphaned();
                com.efi.printsmith.integration.xpedx.xsd.request.ItemDocument.Item target = null;
                target = (com.efi.printsmith.integration.xpedx.xsd.request.ItemDocument.Item)get_store().find_element_user(ITEM$0, i);
                if (target == null)
                {
         ...
         */
        public void setItemArray(com.efi.printsmith.integration.xpedx.xsd.request.ItemDocument.Item[] itemArray)
        {
            check_orphaned();
         ...
         */
        public void setItemArray(int i, com.efi.printsmith.integration.xpedx.xsd.request.ItemDocument.Item item)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public com.efi.printsmith.integration.xpedx.xsd.request.ItemDocument.Item insertNewItem(int i)
        {
            synchronized (monitor())
            {
                check_orphaned();
                com.efi.printsmith.integration.xpedx.xsd.request.ItemDocument.Item target = null;
                target = (com.efi.printsmith.integration.xpedx.xsd.request.ItemDocument.Item)get_store().insert_element_user(ITEM$0, i);
                return target;
            }
        }
