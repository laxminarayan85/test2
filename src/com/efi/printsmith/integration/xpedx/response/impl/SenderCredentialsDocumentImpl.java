 ...
 */
public class SenderCredentialsDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.efi.printsmith.integration.xpedx.response.SenderCredentialsDocument
{
    ...
    public com.efi.printsmith.integration.xpedx.response.SenderCredentialsDocument.SenderCredentials getSenderCredentials()
    {
        synchronized (monitor())
        {
            ...
            target = (com.efi.printsmith.integration.xpedx.response.SenderCredentialsDocument.SenderCredentials)get_store().find_element_user(SENDERCREDENTIALS$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public com.efi.printsmith.integration.xpedx.response.SenderCredentialsDocument.SenderCredentials addNewSenderCredentials()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.efi.printsmith.integration.xpedx.response.SenderCredentialsDocument.SenderCredentials target = null;
            target = (com.efi.printsmith.integration.xpedx.response.SenderCredentialsDocument.SenderCredentials)get_store().add_element_user(SENDERCREDENTIALS$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class SenderCredentialsImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.efi.printsmith.integration.xpedx.response.SenderCredentialsDocument.SenderCredentials
    {
        private static final long serialVersionUID = 1L;
