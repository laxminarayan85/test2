 ...
 */
public class StockCheckResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.efi.printsmith.integration.xpedx.response.StockCheckResponseDocument
{
    ...
    public com.efi.printsmith.integration.xpedx.response.StockCheckResponseDocument.StockCheckResponse getStockCheckResponse()
    {
        synchronized (monitor())
        {
            ...
            target = (com.efi.printsmith.integration.xpedx.response.StockCheckResponseDocument.StockCheckResponse)get_store().find_element_user(STOCKCHECKRESPONSE$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public com.efi.printsmith.integration.xpedx.response.StockCheckResponseDocument.StockCheckResponse addNewStockCheckResponse()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.efi.printsmith.integration.xpedx.response.StockCheckResponseDocument.StockCheckResponse target = null;
            target = (com.efi.printsmith.integration.xpedx.response.StockCheckResponseDocument.StockCheckResponse)get_store().add_element_user(STOCKCHECKRESPONSE$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class StockCheckResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.efi.printsmith.integration.xpedx.response.StockCheckResponseDocument.StockCheckResponse
    {
        private static final long serialVersionUID = 1L;
        ...
        public com.efi.printsmith.integration.xpedx.response.ItemsDocument.Items getItems()
        {
            synchronized (monitor())
            {
                ...
                target = (com.efi.printsmith.integration.xpedx.response.ItemsDocument.Items)get_store().find_element_user(ITEMS$6, 0);
                if (target == null)
                {
                    return null;
                }
        ...
        public com.efi.printsmith.integration.xpedx.response.ItemsDocument.Items addNewItems()
        {
            synchronized (monitor())
            {
                check_orphaned();
                com.efi.printsmith.integration.xpedx.response.ItemsDocument.Items target = null;
                target = (com.efi.printsmith.integration.xpedx.response.ItemsDocument.Items)get_store().add_element_user(ITEMS$6);
                return target;
            }
        }
    }
