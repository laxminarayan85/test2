...
//		} catch (MalformedURLException e) {
//			throw new ServletException("Invalid reportlogo.url: "
//					+ config.getInitParameter("reportlogo.url"), e);
//		}
//
...
//		// try
//		// {
//		// dss = (DataSourceSelector)m_manager.lookup(
//		// DataSourceSelector.class.getName() );
//		//
...
//	}
//
//	public void checkProperties(final Engine engine,
//			final Properties properties, final Object o) throws ReportException {
...
//	}
//
//	public static void replaceLogo(final Engine engine, final LogoLoader logo,
...
//	}
//
//	private static void replaceLogoInArea(final Area area,
//			final LogoLoader logo, final Properties properties)
...
//	}
//
//	private static void replaceLogoInSection(final Section section,
//			final LogoLoader logo, final Properties properties)
//			throws ReportException {
...
//				final FormulaField toolTipsTextFormel = element
//						.getToolTipsTextFormula();
//				final String value = null == toolTipsTextFormel ? ""
//						: toolTipsTextFormel.getFormula();
...
//						final Picture newPicture = section.addPicture(picture
//								.getX(), picture.getY(), picture.getWidth(),
//								picture.getHeight(), logo.getLogo());
//
//						newPicture.setSuppressFormula(picture
//								.getSuppressFormula());
//					}
//
...
//
//						if (null != loaded) {
//							final Picture newPicture = section.addPicture(
//									picture.getX(), picture.getY(), picture
//											.getWidth(), picture.getHeight(),
//									loaded);
//
//							newPicture.setSuppressFormula(picture
//									.getSuppressFormula());
...
//	}
//
//	private void setConnection(final Engine engine, final List connections)
//			throws ReportException {
//		try {
...
//	}
//
//	private void setSubReports(final Engine engine, final List connections)
//			throws ReportException {
...
//		// else
//		// {
//		properties.put( "report", new URL("file:/" + reportName).toExternalForm() );
//		// }
//		// }
//		// catch( MalformedURLException e )
//		// {
...
//
//		try {
//			super.afterPropertiesStoredHook(httpServletRequest,
...
//	}
//
//	public void checkProperties(final Properties properties, final Object o)
//			throws ReportException {
//		final HttpServletRequest request = (HttpServletRequest) o;
...
//
//		if (log.isDebugEnabled())
//			log.debug("Using report name: " + reportName);
//	}
//
...
//
//		buffer.append("Executing" + fileName + " report using "
//				+ parameters.size() + " parameters.");
//
//		while (i.hasNext()) {
//			final Map.Entry entry = (Map.Entry) i.next();
//			final String value = null != entry.getValue() ? (String) ((String[]) (entry
//					.getValue()))[0]
//					: "";
//
...
////		final String name = request.getRequestURI().substring(
////				request.getContextPath().length());
//		final String name = request.getParameter("report");
//		return name;
...
//		final HttpServletResponse response = (HttpServletResponse) properties
//				.remove("appbox.response.key");
//
//		properties.put("title", "report viewer");
//		properties.put("cabbase", "/reports/crystalclear" + m_viewerPrefix
//				+ "/JavaClient.cab");
//		properties.put("archive", "/reports/crystalclear" + m_viewerPrefix
//				+ "/JavaClient.jar");
...
//		}
//
//		String reportString = response.encodeURL(reportUrl);
//		properties.put("report", reportString);
//
...
//	}
//
//	private void closeConnections(final List connections,
...
//
//					IOUtils
//							.copy(method.getResponseBodyAsStream(),
//									outputStream);
//
