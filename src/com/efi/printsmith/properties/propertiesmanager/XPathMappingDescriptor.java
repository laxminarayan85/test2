...
**/
public class XPathMappingDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public XPathMappingDescriptor() {
        super();
        xmlName = "XPathMapping";
        ...
        handler = (new XMLFieldHandler() {
            ...
            {
                XPathMapping target = (XPathMapping) object;
